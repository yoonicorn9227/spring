				...
				<div id="customer">
					...
					<div class="viewDivMt">
						<div class="viewHead">
							...
							<div class="day">
								...
								<fmt:formatDate value="${map.bdto.bdate}" pattern="yyyy-MM-dd" /></span></p>
							</div>
						</div>
					...
					<script>
						...
						$(function(){
							...
							let bno = ${map.bdto.bno}; //bno받아오기
							
							$(".replyBtn").click(function(){
								if("${session_id}"==""){
									alert("로그인을 해야 댓글 작성이 가능합니다.")
									return false;
								}//if(미로그인시)
					...
					<div class="replyWrite">
						<ul>
							...
							<li class="btn"><a href="#" class="replyBtn" style="cursor: pointer;">등록</a></li>
						</ul>
