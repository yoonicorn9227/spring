...
<body>
  ...
  <section>
    ...
    <ul class="login-icons">
      <li class="phone"></li>
      <a href="https://kauth.kakao.com/oauth/authorize?client_id=6d05bc7fa71d49adc3029916eeed8d11&redirect_uri=http://localhost:8000/kakao/oauth&response_type=code" style="text-decoration: none;">
      	<li class="kakao"></li>
      </a>
      <li class="naver"></li>
